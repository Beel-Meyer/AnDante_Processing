...
void loop()
{
    ...
    if (((tomar == true) && (state1 == HIGH)) || ((tomar == true)&&(state2 == HIGH)) || ((tomar == true)&&(state3 == HIGH)) || ((tomar == true)&&(state4 == HIGH))){
        if (currentMillis - previousMillis >= interval) {
            ...
            digitalWrite(outPinAgua, stateAgua);
  ...
  if ((tomar == true) && (state1 == LOW) && (state2 == LOW) && (state3 == LOW) && (state4 == LOW)){
        if (currentMillis - previousMillis >= interval) {
            previousMillis = currentMillis;
            if (stateGlobal == LOW) {
                stateGlobal = HIGH;
            ...
            digitalWrite(outPinGlobal, stateGlobal);
